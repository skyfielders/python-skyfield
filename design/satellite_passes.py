...
print('''
I was hoping the result of the above test would justify abandoning fancy
event-search routines for short satellite passes, in favor of telling
users to just go ahead and compute quantities of interest for every
second over the whole pass.

But the numbers seem to point the other direction: something like a 2x
speedup is achieved if we search for the moment of change in the sunlit
status versus just compute it every second.
''')
