...
from .units import Distance, Velocity, Angle, _from_degrees, _interpret_ltude
...
class ICRS(object):
    ...
    def from_altaz(self, alt=None, az=None, alt_degrees=None, az_degrees=None):
        ...
        if R is None:
            raise ValueError('only a position generated by a Topos'
        ...
        p = from_polar(r, alt_degrees * _from_degrees,
                       az_degrees * _from_degrees)
        p = einsum('ji...,j...->i...', R, p)
        return Apparent(p)
