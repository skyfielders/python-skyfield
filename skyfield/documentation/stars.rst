...
Skyfield can generate positions for stars and any other distance objects
for which you can provide barycentric ICRS coordinates.  To represent
the object, construct a :class:`Star` and observe it from the Earth or
another Solar System body.  The position of Barnard’s Star, for example,
at right ascension 17ʰ57ᵐ48.49803ˢ and declination +4°41′36.2072″ can be
generated by:
...
See the guide to :doc:`positions` for more about all of the operations
that you can perform with these astrometric positions after using a
:class:`Star` object to generate them.
