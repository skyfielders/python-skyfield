...
def off_test_boston_geometry():
    ...
    print([repr(n) for n in (a.position.au - w) / meter])
    from skyfield.functions import length_of
...
def off_test_moon_from_boston_geometry():
    ...
    #print(boston.longitude.degrees+360.0)
    #print(boston.observe(k.moon))
    a = boston.observe(k.moon).at(tdb=(2015, 3, 2))
    print(a.position.au)
    #
    compare(a.position.au,
      [-1.341501206885335E-03, 2.281775998031755E-03, -2.438420054070379E-04],
      0.001 * meter)
